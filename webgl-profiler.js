...
(function () {
  ...
  var WebGLProfiler = /** @class */ (function () {
    ...
    WebGLProfiler.prototype.start = function () {
      if (this.ext == null) {
        throw new Error(
          "EXT_disjoint_timer_query WebGL extension is not available. Cannot start profiler.",
        );
      }
      if (this.isRunning) {
      ...
      if (infoExt != null) {
        var renderer = this.context.getParameter(
          infoExt.UNMASKED_RENDERER_WEBGL,
        );
        if (renderer.indexOf("NVIDIA GeForce GT 750M") !== -1) {
          // See: https://twitter.com/jlfwong/status/1058475013546770432
          throw new Error(
            renderer +
              " cards seem to have a buggy implementation of EXT_disjoint_timer_query. Refusing to record to avoid misleading results.",
          );
        }
      }
      this.isRunning = true;
    ...
    WebGLProfiler.prototype.popContext = function (name) {
      if (this.namedContextStack.length === 0) {
        throw new Error(
          "Tried to pop a context when the context stack is empty!",
        );
      }
      var popped = this.namedContextStack.pop();
      if (popped !== name) {
        throw new Error(
          "Expected popContext to be called with " +
            popped +
    ...
    WebGLProfiler.prototype.exportSpeedscopeProfile = function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!(this.eventsPendingTimestamps.length > 0))
                return [3 /*break*/, 2];
            ...
            case 1:
              ...
              return [3 /*break*/, 0];
            case 2:
              return [2 /*return*/, this.toSpeedscopeProfile()];
          }
        });
      });
    };
    WebGLProfiler.prototype.downloadWhenReady = function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.exportSpeedscopeProfile()];
            case 1:
              profileText = _a.sent();
              link = document.createElement("a");
              link.href = URL.createObjectURL(
                new Blob([profileText], { type: "application/json" }),
              );
    ...
    WebGLProfiler.prototype.resolveEventsIfPossible = function () {
      ...
      while (i < this.eventsPendingTimestamps.length) {
        ...
        var elapsed = this.ext.getQueryObjectEXT(
          query,
        ...
        var lastTimestamp =
          this.resolvedEvents.length === 0
            ? 0
            : this.resolvedEvents[this.resolvedEvents.length - 1].timestamp;
    ...
    WebGLProfiler.prototype.toSpeedscopeProfile = function () {
      ...
      for (var _i = 0, _a = this.resolvedEvents; _i < _a.length; _i++) {
        ...
        speedscopeEvents.push({
          type:
            event_1.action.type == GPUProfilerActionType.OPEN_FRAME
              ? SpeedscopeEventType.OPEN_FRAME
              : SpeedscopeEventType.CLOSE_FRAME,
  ...
  (function (GPUProfilerActionType) {
    GPUProfilerActionType[(GPUProfilerActionType["OPEN_FRAME"] = 0)] =
      "OPEN_FRAME";
    GPUProfilerActionType[(GPUProfilerActionType["CLOSE_FRAME"] = 1)] =
      "CLOSE_FRAME";
